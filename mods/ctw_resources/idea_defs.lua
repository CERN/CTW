...
ctw_resources.register_idea("apollo_domain", {
	...
	description = "This technology implements remote-controlling servers on the network." ..
...
ctw_resources.register_idea("tcp_ip", {
	...
	description = "Network packets are often lost, corrupted or only partially available." ..
...
ctw_resources.register_idea("router", {
	name = "Wire routing",
	description = "Some of our cables are only used partially. Please invent something"..
